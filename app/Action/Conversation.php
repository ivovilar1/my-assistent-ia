...
class Conversation
{
    ...
    public function createUserTask($description, $due_at, $meta, $additional_info = '', $reminder_at = ''): Task
    {
    ...
    // O ChatGPT agora aceita chamadas de funcoes para complementar o prompt
    // Então esse metodo faz uma recursao ate o chatgpt devolver a mensagem
    public function talkToGpt($messages, $clearMemory = false)
    {
        $client = \OpenAI::client(config('services.openai.auth_token'));
